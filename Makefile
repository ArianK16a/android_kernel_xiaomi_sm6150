...
export CPP AR NM STRIP OBJCOPY OBJDUMP OBJSIZE READELF HOSTLDFLAGS
export HOST_LOADLIBES MAKE AWK GENKSYMS INSTALLKERNEL PERL PYTHON
export UTS_MACHINE HOSTCXX HOSTCXXFLAGS LDFLAGS_MODULE CHECK CHECKFLAGS
