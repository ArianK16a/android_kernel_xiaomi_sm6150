...
TRACE_EVENT(sched_task_util,
	...
	TP_printk("pid=%d comm=%s util=%lu prev_cpu=%d next_cpu=%d backup_cpu=%d target_cpu=%d sync=%d need_idle=%d fastpath=%d placement_boost=%d rtg_cpu=%d latency=%llu stune_boosted=%d is_rtg=%d",
		...
		__entry->stune_boosted, __entry->is_rtg)
)
